...
public final class i extends HealthItemEntity {

    /* renamed from: f */
    public final int f25626f;

    public /* synthetic */ i(long j10, Date date, int i10, int i11, int i12) {
        this(j10, date, i10, (i12 & 8) != 0 ? 0 : i11, (i12 & 16) != 0 ? 1 : 0, 0);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(long j10, Date date, int i10, int i11, int i12, int i13) {
