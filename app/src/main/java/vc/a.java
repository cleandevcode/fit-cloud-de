...
public final class a {
    ...
    /* renamed from: a */
    public static final Map<Integer, String> f29194a;
    ...
    static {
        ...
        hashMap.put(Integer.valueOf((int) DfuBaseService.ERROR_REMOTE_TYPE_LEGACY), "GATT_CONN_CANCEL");
        f29194a = Collections.unmodifiableMap(hashMap);
    }
}
