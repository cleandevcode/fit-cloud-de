...
public final class j {
    ...
    public static final String a(String str) {
        ...
        jVar.getClass();
        BufferedInputStream bufferedInputStream = new BufferedInputStream(new FileInputStream(file), DfuBaseService.ERROR_REMOTE_TYPE_SECURE_EXTENDED);
        try {
            ...
            gm.l.e(bigInteger, "BigInteger(1, md.digest()).toString(16)");
