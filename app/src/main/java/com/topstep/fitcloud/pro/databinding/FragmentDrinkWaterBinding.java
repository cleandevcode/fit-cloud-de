...
public final class FragmentDrinkWaterBinding implements a {
    public final AppBarLayout appbar;
    public final ImageView imgIcon;
    public final PreferenceItem itemDetailEnabled;
    public final PreferenceItem itemEndTime;
    public final PreferenceItem itemInterval;
            ...
            if (imageView != null) {
                ...
                if (preferenceItem != null) {
                    ...
                    if (preferenceItem2 != null) {
                        ...
                        PreferenceItem preferenceItem3 = (PreferenceItem) c.m(view, R.id.item_interval);
                                ...
                                if (linearLayout != null) {
                                    ...
                                    if (linearLayout2 != null) {
                                        ...
                                        if (fitPaddingMaterialToolbar != null) {
                                            ...
                                            if (textView != null) {
                                                return new FragmentDrinkWaterBinding((CoordinatorLayout) view, appBarLayout, imageView, preferenceItem, preferenceItem2, preferenceItem3, preferenceItem4, linearLayout, linearLayout2, fitPaddingMaterialToolbar, textView);
                                            }
                                        }
                                    }
                                }
    ...
    public static FragmentDrinkWaterBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
