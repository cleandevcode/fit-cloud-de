...
public final class FragmentAlarmListBinding implements a {
    ...
    private FragmentAlarmListBinding(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, FloatingActionButton floatingActionButton, LoadingView loadingView, RecyclerView recyclerView, MaterialToolbar materialToolbar) {
                ...
                if (loadingView != null) {
                    ...
                    if (recyclerView != null) {
                        ...
                        if (materialToolbar != null) {
                            return new FragmentAlarmListBinding((CoordinatorLayout) view, appBarLayout, floatingActionButton, loadingView, recyclerView, materialToolbar);
                        }
                    }
                }
            }
    ...
    public static FragmentAlarmListBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
