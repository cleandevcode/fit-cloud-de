...
public abstract class HianalyticsBaseData {
    ...
    /* renamed from: a */
    public LinkedHashMap<String, String> f7048a;

    public HianalyticsBaseData() {
        LinkedHashMap<String, String> linkedHashMap = new LinkedHashMap<>();
        this.f7048a = linkedHashMap;
        linkedHashMap.put(SDK_TYPE, "UxPP");
        this.f7048a.put(SDK_NAME, "networkkit");
    }
    ...
    public HianalyticsBaseData put(String str, long j10) {
        if (str == null) {
            ...
            LinkedHashMap<String, String> linkedHashMap = this.f7048a;
    ...
    public HianalyticsBaseData put(LinkedHashMap<String, String> linkedHashMap) {
        if (linkedHashMap == null || linkedHashMap.isEmpty()) {
            ...
            this.f7048a.putAll(linkedHashMap);
        }
        return this;
    }
