...
public class CountryCodeBean {
    ...
    private void getProductCountryCode() {
        ...
        String str = TAG;
        StringBuilder a10 = d.a("countryCode by ro.product.locale.region is:");
        ...
        if (TextUtils.isEmpty(this.countryCode) || GrsBaseInfo.CountryCodeSource.UNKNOWN.equals(this.countryCode)) {
            ...
            if (!TextUtils.isEmpty(property) && (lastIndexOf = property.lastIndexOf("-")) != -1) {
                ...
                StringBuilder a11 = d.a("countryCode by ro.product.locale is:");
    ...
    private void getRegionSettingCountryCode() {
        ...
        String str = TAG;
        StringBuilder a10 = d.a("countryCode by system's region setting is: ");
        a10.append(this.countryCode);
        Logger.i(str, a10.toString());
    ...
    private void getVendorCountryCode() {
        ...
        String str = TAG;
        StringBuilder a10 = d.a("countryCode by ro.hw.country is: ");
        a10.append(this.countryCode);
        Logger.i(str, a10.toString());
