...
public final class C0668gc {
    ...
    static {
        ...
        for (int i11 = 0; i11 < 255; i11++) {
            try {
                ...
                int[] iArr2 = f7906c;
                if (com.huawei.hms.scankit.util.b.a(iArr2, i10)) {
                    iArr2[i10] = i11;
                }
                i10 *= 2;
                if (i10 >= 256) {
    ...
    public static String a(String str, C0676ic c0676ic) {
        if (str.length() != c0676ic.a()) {
            try {
        ...
        StringBuilder sb2 = new StringBuilder(c0676ic.b() + c0676ic.a());
        sb2.append(str);
        int c10 = c0676ic.c();
        if (c10 == 1) {
            sb2.append(a(str, c0676ic.b()));
        } else {
            ...
            while (i10 < c10) {
                int i11 = i10 + 1;
                iArr[i10] = c0676ic.a(i11);
                iArr2[i10] = c0676ic.b(i11);
                iArr3[i10] = 0;
                if (i10 > 0) {
            ...
            for (int i12 = 0; i12 < c10; i12++) {
                ...
                for (int i13 = i12; i13 < c0676ic.a(); i13 += c10) {
                    sb3.append(str.charAt(i13));
                }
                String a10 = a(sb3.toString(), iArr2[i12]);
                int i14 = i12;
                int i15 = 0;
                while (i14 < iArr2[i12] * c10) {
                    sb2.setCharAt(c0676ic.a() + i14, a10.charAt(i15));
                    i14 += c10;
                    i15++;
                }
            }
