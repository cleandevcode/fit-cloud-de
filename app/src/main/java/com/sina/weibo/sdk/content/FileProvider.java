...
public class FileProvider extends ContentProvider {
    ...
    public static class b implements a {
        ...
        /* renamed from: h */
        public final HashMap<String, File> f9503h = new HashMap<>();
        ...
        public final Uri a(File file) {
            try {
                ...
                for (Map.Entry<String, File> entry2 : this.f9503h.entrySet()) {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.f9502g).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(substring, "/")).build();
                }
        ...
        public final File a(Uri uri) {
            ...
            File file = this.f9503h.get(decode);
            if (file != null) {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if (file != null) {
                    ...
                    try {
                        bVar.f9503h.put(attributeValue, buildPath.getCanonicalFile());
                    } catch (IOException e10) {
                        throw new IllegalArgumentException("Failed to resolve canonical path for ".concat(String.valueOf(buildPath)), e10);
                    }
                } else {
                    continue;
                }
