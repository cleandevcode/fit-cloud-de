...
public final class d extends b {
    ...
    public final void a(Bundle bundle) {
        ...
        bundle.putString("token", this.f9534ae);
        bundle.putString(MLApplicationSetting.BundleKeyConstants.AppInfo.packageName, this.packageName);
    }

    @Override // com.sina.weibo.sdk.web.b.b
    public final void a(final b.a aVar) {
        com.sina.weibo.sdk.a.b bVar;
        com.sina.weibo.sdk.a.d dVar = new com.sina.weibo.sdk.a.d(this.Z, new String(this.aF), this.aC.a().getAppKey(), this.f9534ae, new com.sina.weibo.sdk.net.c<String>() { // from class: com.sina.weibo.sdk.web.b.d.1
    ...
    public final void b(Bundle bundle) {
        ...
        this.f9534ae = bundle.getString("token");
        this.packageName = bundle.getString(MLApplicationSetting.BundleKeyConstants.AppInfo.packageName);
    ...
    public final String getUrl() {
        ...
        buildUpon.appendQueryParameter(InnerShareParams.TITLE, this.text);
        buildUpon.appendQueryParameter(WiseOpenHianalyticsData.UNION_VERSION, "0041005000");
        String appKey = this.aC.a().getAppKey();
        if (!TextUtils.isEmpty(appKey)) {
            buildUpon.appendQueryParameter("source", appKey);
        }
        if (!TextUtils.isEmpty(this.f9534ae)) {
            buildUpon.appendQueryParameter(Oauth2AccessToken.KEY_ACCESS_TOKEN, this.f9534ae);
        }
