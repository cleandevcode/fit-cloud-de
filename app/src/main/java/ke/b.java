...
public final class b {
    ...
    /* renamed from: a */
    public static final ArrayList<re.a> f18455a;
    ...
    static {
        ...
        arrayList.add(new re.a(14, "Factory", 2560, false, 1));
        ...
        arrayList.add(new re.a(24, "Platform Ext", 10145, 517, false, 3, false));
    }

    public static re.a a(int i10) {
        Iterator<re.a> it = f18455a.iterator();
        while (it.hasNext()) {
            re.a next = it.next();
            if (next.f25546d == i10) {
                return next;
