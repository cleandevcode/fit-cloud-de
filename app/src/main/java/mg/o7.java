...
public final class o7 implements Callable<List<rg.r>> {

    /* renamed from: a */
    public final /* synthetic */ m2.y f21340a;

    /* renamed from: b */
    public final /* synthetic */ h7 f21341b;

    public o7(h7 h7Var, m2.y yVar) {
        this.f21341b = h7Var;
        this.f21340a = yVar;
    }
    ...
    public final List<rg.r> call() {
        ...
        String string2;
        int i10;
        Cursor r10 = o8.b.r(this.f21341b.f21063a, this.f21340a);
        try {
