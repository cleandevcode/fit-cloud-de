...
public final class f8 implements Callable<StepRecordEntity> {

    /* renamed from: a */
    public final /* synthetic */ m2.y f21003a;

    /* renamed from: b */
    public final /* synthetic */ s8 f21004b;

    public f8(s8 s8Var, m2.y yVar) {
        this.f21004b = s8Var;
        this.f21003a = yVar;
    }
    ...
    public final StepRecordEntity call() {
        String string;
        Cursor r10 = o8.b.r(this.f21004b.f21418a, this.f21003a);
        try {
