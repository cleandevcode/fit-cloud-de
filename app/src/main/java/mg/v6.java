...
public final class v6 extends m2.i<rg.o> {
    ...
    public final String b() {
        return "INSERT OR IGNORE INTO `SleepDetail` (`userId`,`time`,`deepSleep`,`lightSleep`,`soberSleep`,`lastModifyTime`,`detail`,`uploadFlag`,`uploadAttempts`) VALUES (?,?,?,?,?,?,?,?,?)";
    }
