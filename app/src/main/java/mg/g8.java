...
public final class g8 implements Callable<List<StepRecordEntity>> {

    /* renamed from: a */
    public final /* synthetic */ m2.y f21032a;

    /* renamed from: b */
    public final /* synthetic */ s8 f21033b;

    public g8(s8 s8Var, m2.y yVar) {
        this.f21033b = s8Var;
        this.f21032a = yVar;
    }
    ...
    public final List<StepRecordEntity> call() {
        String string;
        Cursor r10 = o8.b.r(this.f21033b.f21418a, this.f21032a);
        try {
