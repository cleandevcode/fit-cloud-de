...
public abstract class InnerShareParams {
    ...
    public InnerShareParams(String str) {
        this(android.support.v4.media.d.b(str));
    }
    ...
    public <T> T get(String str, Class<T> cls) {
        ...
        if (Byte.class.equals(cls) || Byte.TYPE.equals(cls)) {
            ...
            b10 = Boolean.FALSE;
        } else if (!HashMap.class.equals(cls) && !Map.class.equals(cls)) {
            return null;
        } else {
            b10 = new HashMap();
        }
    ...
    public void setContentType(int i10) {
        set(CONTENT_TYPE, Integer.valueOf(i10));
    }
    ...
    public void setDouyinShareToPublish(boolean z10) {
        set(SHARE_TO_PUBLISH, Boolean.valueOf(z10));
    }
    ...
    public void setFamily(boolean z10) {
        set(IS_FAMILY, Boolean.valueOf(z10));
    }
    ...
    public void setFriend(boolean z10) {
        set(IS_FRIEND, Boolean.valueOf(z10));
    }
    ...
    public void setHidden(int i10) {
        set(HIDDEN, Integer.valueOf(i10));
    }
    ...
    public void setKakaoCommentcount(int i10) {
        set(KAKAO_TEMPLATE_COMMENTCOUNT, Integer.valueOf(i10));
    }
    ...
    public void setKakaoDiscountprice(int i10) {
        set(KAKAO_TEMPLATE_DISCOUNTPRICE, Integer.valueOf(i10));
    }

    public void setKakaoDiscountrate(int i10) {
        set(KAKAO_TEMPLATE_DISCOUNTRATE, Integer.valueOf(i10));
    }

    public void setKakaoLikecount(int i10) {
        set(KAKAO_TEMPLATE_LIKECOUNT, Integer.valueOf(i10));
    }
    ...
    public void setKakaoRegularprice(int i10) {
        set(KAKAO_TEMPLATE_REGULARPRICE, Integer.valueOf(i10));
    }

    public void setKakaoSharecount(int i10) {
        set(KAKAO_TEMPLATE_SHARECOUNT, Integer.valueOf(i10));
    }
    ...
    public void setLatitude(float f10) {
        set(LATITUDE, Float.valueOf(f10));
    }
    ...
    public void setLongitude(float f10) {
        set(LONGITUDE, Float.valueOf(f10));
    }
    ...
    public void setOpenCustomEven(boolean z10) {
        set(IS_LOG_EVEN, Boolean.valueOf(z10));
    }

    public void setPublic(boolean z10) {
        set(IS_PUBLIC, Boolean.valueOf(z10));
    }
    ...
    public void setSafetyLevel(int i10) {
        set(SAFETY_LEVEL, Integer.valueOf(i10));
    }

    public void setScence(int i10) {
        set(SCENCE, Integer.valueOf(i10));
    }

    public void setShareTencentWeibo(boolean z10) {
        set(IS_SHARE_TENCENT_WEIBO, Boolean.valueOf(z10));
    }

    public void setShareType(int i10) {
        set(SHARE_TYPE, Integer.valueOf(i10));
    }
    ...
    public void setTagPosition(int i10) {
        set(TAG_POSITION, Integer.valueOf(i10));
    }
    ...
    public void setWxMiniProgramType(int i10) {
        set(WX_MINIPROGRAM_MINIPROGRAM_TYPE, Integer.valueOf(i10));
    }
    ...
    public void setWxWithShareTicket(boolean z10) {
        set(WX_MINIPROGRAM_WITH_SHARETICKET, Boolean.valueOf(z10));
    }
