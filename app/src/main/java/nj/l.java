        ...
        */
        public a(byte[] r5) {
            ...
            L12:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: nj.l.a.<init>(byte[]):void");
        }

        public final l b() {
            return new l(this.f21880b);
        }
    }
    ...
    */
    public l(byte[] r5) {
        ...
        L12:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: nj.l.<init>(byte[]):void");
    }

    @Override // mj.a
    public final byte[] c(c cVar) {
        gm.l.f(cVar, "deviceInfo");
        boolean g10 = cVar.g(275);
