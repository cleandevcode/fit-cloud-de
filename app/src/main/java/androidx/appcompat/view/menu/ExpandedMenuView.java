...
public final class ExpandedMenuView extends ListView implements f.b, k, AdapterView.OnItemClickListener {
    ...
    /* renamed from: b */
    public static final int[] f853b = {16842964, 16843049};
    ...
    public ExpandedMenuView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f853b, 16842868, 0);
        if (obtainStyledAttributes.hasValue(0)) {
            if (obtainStyledAttributes.hasValue(0) && (resourceId2 = obtainStyledAttributes.getResourceId(0, 0)) != 0) {
                drawable2 = g.a.b(context, resourceId2);
            } else {
    ...
    public final boolean a(h hVar) {
        return this.f854a.q(hVar, null, 0);
    }
