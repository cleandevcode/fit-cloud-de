...
public class a extends CardView implements Checkable, m {
    ...
    /* renamed from: i */
    public static final int[] f23966i = {R.attr.state_dragged};
    ...
    public final int[] onCreateDrawableState(int i10) {
        ...
        if (this.f23967h) {
            View.mergeDrawableStates(onCreateDrawableState, f23966i);
        }
    ...
    public void setOnCheckedChangeListener(InterfaceC0433a interfaceC0433a) {
    }
